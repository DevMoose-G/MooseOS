...
Binaries/full_kernel.bin: Binaries/kernel_entry.o Binaries/kernel.o Binaries/func.o
	i386-elf-ld -o "Binaries/full_kernel.bin" -Ttext 0x1000 "Binaries/kernel_entry.o" "Binaries/kernel.o" "Binaries/func.o" --oformat binary
